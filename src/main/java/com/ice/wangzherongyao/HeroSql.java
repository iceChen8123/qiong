...
//        sql.append("(" + namePinyinCache.get(hero.getName()) + ")-[:parterner {desc: '" + parternerHero.getInfo() + "'}]->(" + namePinyinCache.get(parternerHero.getHeroName()) + ")")
//                .append(" ,");
//      });
//    });
//    heroList.forEach(hero -> {
//      hero.getResistHeroList().forEach(resistHero -> {
//        sql.append("(" + namePinyinCache.get(resistHero.getHeroName()) + ")-[:resist {desc: '" + resistHero.getInfo() + "'}]->(" + namePinyinCache.get(hero.getName()) + ")")
//                .append(" ,");
//      });
//    });
//    heroList.forEach(hero -> {
//      hero.getInhibitHeroList().forEach(inhibitHero -> {
//        sql.append("(" + namePinyinCache.get(hero.getName()) + ")-[:inhibit {desc: '" + inhibitHero.getInfo() + "'}]->(" + namePinyinCache.get(inhibitHero.getHeroName()) + ")")
//                .append(" ,");
//      });
//    });
